...
var _sbaechler$polygon$Native_Audio = function() {
  ...
  function playSound(options, sound) {
    return Task.nativeBinding(function (callback) {
      ...
      console.log('playing audio: ', sound, options);
...
var _sbaechler$polygon$Audio$stopSound = _sbaechler$polygon$Native_Audio.stopSound;
var _sbaechler$polygon$Audio$playSound = _sbaechler$polygon$Native_Audio.playSound;
var _sbaechler$polygon$Audio$loadSound = _sbaechler$polygon$Native_Audio.loadSound;
var _sbaechler$polygon$Audio$PlaybackOptions = F3(
	function (a, b, c) {
		return {volume: a, startAt: b, loop: c};
	});
var _sbaechler$polygon$Audio$defaultPlaybackOptions = A3(
	_sbaechler$polygon$Audio$PlaybackOptions,
	1.0,
	_elm_lang$core$Maybe$Just(0.0),
	false);
var _sbaechler$polygon$Audio$Sound = {ctor: 'Sound'};

var _sbaechler$polygon$Main$formatTime = function (running) {
...
var _sbaechler$polygon$Main$makeTextBox = F2(
...
var _sbaechler$polygon$Main$trapezoid = F3(
...
var _sbaechler$polygon$Main$updateMsRunning = F2(
...
var _sbaechler$polygon$Main$loadSound = _sbaechler$polygon$Audio$loadSound('music/shinytech.mp3');
var _sbaechler$polygon$Main$hasBass = function (time) {
...
var _sbaechler$polygon$Main$makeEnemy = F2(
	function (color, enemy) {
		var base = (2.0 * (enemy.radius + _sbaechler$polygon$Main$enemyThickness)) / _elm_lang$core$Basics$sqrt(3);
		var makeEnemyPart = function (index) {
			return A3(
				_sbaechler$polygon$Main$moveRadial,
				_elm_lang$core$Basics$degrees(
					_elm_lang$core$Basics$toFloat(index * 60)),
				enemy.radius + _sbaechler$polygon$Main$enemyThickness,
				A2(
					_evancz$elm_graphics$Collage$rotate,
					_elm_lang$core$Basics$degrees(
						_elm_lang$core$Basics$toFloat(90 + (index * 60))),
					A3(_sbaechler$polygon$Main$trapezoid, base, _sbaechler$polygon$Main$enemyThickness, color)));
		};
...
var _sbaechler$polygon$Main$makeEnemies = F2(
	function (color, enemys) {
		return A2(
			_elm_lang$core$List$map,
...
var _sbaechler$polygon$Main$hexagonElement = function (i) {
	...
	var radius = _sbaechler$polygon$Main$halfWidth * _elm_lang$core$Basics$sqrt(2);
	return _elm_lang$core$Native_List.fromArray(
		[
...
var _sbaechler$polygon$Main$makeField = function (colors) {
	...
	var poly = function (i) {
		return A2(
			...
			color(i),
			_evancz$elm_graphics$Collage$polygon(
				_sbaechler$polygon$Main$hexagonElement(i)));
	};
	return _evancz$elm_graphics$Collage$group(
		A2(
			_elm_lang$core$List$map,
...
var _sbaechler$polygon$Main$colidesWith = F2(
	function (player, enemy) {
		...
		return ((_elm_lang$core$Native_Utils.cmp(enemy.radius, _sbaechler$polygon$Main$playerRadius) > 0) || (_elm_lang$core$Native_Utils.cmp(enemy.radius + _sbaechler$polygon$Main$enemyThickness, _sbaechler$polygon$Main$playerRadius) < 0)) ? false : A2(
			_elm_lang$core$List$any,
			collidesAtIndex,
			A2(
				_elm_lang$core$List$map,
...
var _sbaechler$polygon$Main$makePlayer = function (player) {
	...
	return A2(
		...
		A3(
			_sbaechler$polygon$Main$moveRadial,
			angle,
			_sbaechler$polygon$Main$playerRadius - 10,
			A2(
				_evancz$elm_graphics$Collage$filled,
				A3(_elm_lang$core$Color$hsl, angle, 1, 0.5),
				A2(_evancz$elm_graphics$Collage$ngon, 3, 10))));
};
var _sbaechler$polygon$Main$Player = function (a) {
	return {angle: a};
};
var _sbaechler$polygon$Main$Enemy = F2(
	function (a, b) {
		return {radius: a, parts: b};
	});
var _sbaechler$polygon$Main$Game = function (a) {
	return function (b) {
		return function (c) {
			return function (d) {
				return function (e) {
...
var _sbaechler$polygon$Main$Colors = F3(
	function (a, b, c) {
...
var _sbaechler$polygon$Main$Play = {ctor: 'Play'};
var _sbaechler$polygon$Main$view = function (game) {
	var bg = A2(
		_evancz$elm_graphics$Collage$filled,
		_sbaechler$polygon$Main$bgBlack,
		A2(_evancz$elm_graphics$Collage$rect, _sbaechler$polygon$Main$gameWidth, _sbaechler$polygon$Main$gameHeight));
	var message = A2(
	...
	var field = _evancz$elm_graphics$Collage$group(
		A2(
			...
			_elm_lang$core$Native_List.fromArray(
				[
					_sbaechler$polygon$Main$makeField(colors),
					_sbaechler$polygon$Main$makePlayer(game.player),
					_evancz$elm_graphics$Collage$group(
					A2(_sbaechler$polygon$Main$makeEnemies, colors.bright, game.enemies))
				]),
			A2(_sbaechler$polygon$Main$makeCenterHole, colors, game)));
	return _evancz$elm_graphics$Element$toHtml(
		A4(
			_evancz$elm_graphics$Element$container,
			_sbaechler$polygon$Main$gameWidth,
			_sbaechler$polygon$Main$gameHeight,
			...
			A3(
				...
				_elm_lang$core$Native_List.fromArray(
					[
						bg,
						A2(
						_sbaechler$polygon$Main$beatPulse,
						game,
						...
						A2(
						_evancz$elm_graphics$Collage$move,
						{ctor: '_Tuple2', _0: 100 - _sbaechler$polygon$Main$halfWidth, _1: _sbaechler$polygon$Main$halfHeight - 40},
						_evancz$elm_graphics$Collage$toForm(score)),
						A2(
						_evancz$elm_graphics$Collage$move,
						{ctor: '_Tuple2', _0: 0, _1: 40 - _sbaechler$polygon$Main$halfHeight},
						_evancz$elm_graphics$Collage$toForm(
							_elm_lang$core$Native_Utils.eq(game.state, _sbaechler$polygon$Main$Play) ? A2(_evancz$elm_graphics$Element$spacer, 1, 1) : A2(_sbaechler$polygon$Main$makeTextBox, 20, _sbaechler$polygon$Main$startMessage)))
					]))));
};
...
var _sbaechler$polygon$Main$playSound = F2(
...
var _sbaechler$polygon$Main$subscriptions = function (game) {
	return _elm_lang$core$Platform_Sub$batch(
		_elm_lang$core$Native_List.fromArray(
			[
				_elm_lang$animation_frame$AnimationFrame$times(
				function (time) {
					return _sbaechler$polygon$Main$Step(time);
				}),
...
var Elm = {};
Elm['Main'] = Elm['Main'] || {};
_elm_lang$core$Native_Platform.addPublicModule(Elm['Main'], 'Main', typeof _sbaechler$polygon$Main$main === 'undefined' ? null : _sbaechler$polygon$Main$main);
Elm['Main'] = Elm['Main'] || {};
_elm_lang$core$Native_Platform.addPublicModule(Elm['Main'], 'Main', typeof _sbaechler$polygon$Main$main === 'undefined' ? null : _sbaechler$polygon$Main$main);
